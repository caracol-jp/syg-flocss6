...
const siteData = deserializeFunctions(JSON.parse('{"lang":"ja-JP","dir":"ltr","title":"syg-flocss6","description":"FLOCSS ベースの CSS フレームワーク","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"ガイド","link":"/guide/getting-started"},{"text":"コンポーネント","link":"/component/"}],"sidebar":[{"text":"ガイド","items":[{"text":"はじめに","link":"/guide/getting-started"}]},{"text":"Core（CSS 変数）","items":[{"text":"概要","link":"/core/"}]},{"text":"Foundation","items":[{"text":"概要","link":"/foundation/"}]},{"text":"Layout","items":[{"text":"概要","link":"/layout/"}]},{"text":"Component","items":[{"text":"概要","link":"/component/"}]},{"text":"Effect","items":[{"text":"概要","link":"/effect/"}]},{"text":"Utility","items":[{"text":"概要","link":"/utility/"}]}],"docFooter":{"prev":"前のページ","next":"次のページ"},"outline":{"label":"目次"},"darkModeSwitchLabel":"ダークモード","sidebarMenuLabel":"メニュー","returnToTopLabel":"トップへ戻る","lastUpdatedText":"最終更新"},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
